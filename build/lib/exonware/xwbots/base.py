...
class ABot(IBot, ABC):
    ...
    def add_api_agent(self, agent: Any, name: str | None = None) -> None:
    ...
    def add_chat_agent(self, agent: Any, name: str | None = None) -> None:
...
class ABotCommand(IBotCommand, ABot, ABC):
    ...
    def register_command(self, command_name: str, handler: Callable, roles: list[str] | None = None) -> None:
...
class ACommandHandler(ICommandHandler, ABC):
    ...
    def register(self, command_name: str, handler: Any, roles: list[str] | None = None) -> None:
